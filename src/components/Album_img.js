        ...
        return(
          ...
          {this.props.mode==="album"&&!this.props.defautImgeHave&&!this.props.imageNameShow&&!this.props.imageNameCheck&&
            ...
            <MDBCol md="1" >
                    ...
                    {this.props.check&& 
                      ...
                      return <MDBCol md="4" key={index+image}>
                              ...
                              <div className="mask flex-center rgba-green-slight">
                                <MDBBtn id={image} color="warning" size="sm" className="" name="sizeUp" onClick={() => this.setState({ isOpen: true })}><MDBIcon icon="search-plus fa-2x" /><br></br>확대</MDBBtn>
                                <MDBBtn id={image} color="indigo" size="sm" className="" name="update" onClick={this.props.onClick }><MDBIcon icon="marker fa-2x" /><br></br>수정</MDBBtn>
                                <MDBBtn id={image} color="danger" size="sm" className="" name="delete" onClick={this.props.onClick}><MDBIcon icon="trash fa-2x" /><br></br>삭제</MDBBtn>
                              </div>
                            </div>
                            </MDBCol>
                      })}
                ...
                (
                <Lightbox
                  mainSrc={this.props.imgUrls[photoIndex]}
