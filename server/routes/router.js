...
const first_signUp = require('../etc/method/eachPage').first_signUp;
const second_signUp = require('../etc/method/eachPage').second_signUp;
const backtofirst = require('../etc/method/eachPage').backtofirst;
